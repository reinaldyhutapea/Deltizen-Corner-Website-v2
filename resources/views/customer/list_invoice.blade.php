{{-- resources/views/customer/list_invoice.blade.php --}}
@extends('layouts.frontend')

@section('title', 'Pesanan Saya - Deltizen Corner')

@section('content')
<section class="section">
    <div class="container section-title" data-aos="fade-up">
        <h2>Pesanan Saya</h2>
        <p><span>Riwayat</span> <span class="description-title">Pesanan Anda</span></p>
    </div>
